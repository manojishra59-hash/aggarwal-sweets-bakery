...
-- ADMIN AUTHENTICATED FULL CONTROL POLICIES
CREATE POLICY "Admin Full Control Products" ON public.products FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Admin Full Control Orders" ON public.orders FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Admin Full Control Inventory" ON public.inventory FOR ALL USING (auth.role() = 'authenticated');
CREATE POLICY "Admin Full Control Table Bookings" ON public.table_bookings FOR ALL USING (auth.role() = 'authenticated');
`;
